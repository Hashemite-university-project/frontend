...
function TasksWorkSpace() {
    ...
    const [active, setStatusFilter] = useState("All");

        const filteredTasks = tasks.filter((task) => 
            active === "All" || task.status === active
        );
  ...
  return (
    <DashboardLayout>
      <main className="md:ml-64 h-screen">
                                            ...
                                            {tasks.map((task) => (
                                                ...
                                                <td className="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                                    ...
                                                    className={`relative inline-block px-3 py-1 font-semibold leading-tight ${
                                                        task.status === "completed" ? "text-green-900" : "text-orange-900"
                                                    }`}
                                                    >
                                                    <span
                                                        aria-hidden
                                                        className={`absolute inset-0 ${
                                                        task.status === "completed" ? "bg-green-200" : "bg-orange-200"
        ...
        <button className="fixed bottom-4 right-4 rounded-lg border-2 border-transparent bg-blue-600 px-4 py-2 font-medium text-white focus:outline-none focus:ring hover:bg-blue-700 text-sm shadow-lg">
          Add Task
        </button>
