...
function Profile() {
    ...
    return (
        <DashboardLayout>
            <main className="p-4 md:ml-64 h-auto h-screen">
                {role !== 3 ? (
                    ...
                    <div className="grid grid-cols-4 sm:grid-cols-12 gap-6 px-4">
                        ...
                        <div className="bg-white shadow rounded-lg p-6">
                            ...
                            <img
                                src={user.user.user_img? user.user.user_img : 'https://cdn-icons-png.flaticon.com/512/149/149071.png'}
                                alt="Profile"
                        ...
                        <div className="bg-white shadow rounded-lg p-6">
                            ...
                            {role === 1 ? (
                                courses.map((course, index) => (
                                    <div key={index} className="mb-6">
                                    <div className="flex justify-between flex-wrap gap-2 w-full">
                                        <span className="text-gray-700 font-bold text-xs">{course.course.course_name}</span>
                                    </div>
                                    <p className="mt-2 text-xs">
                                    ...
                                    courses.map((course, index) => (
                                        <div key={index} className="mb-6">
                                        <div className="flex justify-between flex-wrap gap-2 w-full">
                                            <span className="text-gray-700 font-bold text-xs">{course.course_name}</span>
                                        </div>
                                        <p className="mt-2 text-xs">
                                            {course.course_description.length > 350
                                            ? `${course.course_description.slice(0, 350)}...`
                    ...
                    <div class="px-5 py-2 flex flex-col gap-3 pb-6">
                      <div class="h-[90px] shadow-md w-[90px] rounded-full border-4 overflow-hidden -mt-14 border-white"><img src={user.user_img}/></div>
                      <div class="">
                        <h3 class="text-xl text-slate-900 relative font-bold leading-6">{user.user_name}</h3>
                        <p class="text-sm text-gray-600">{user.user_email}</p>
                      </div>
                      <div class="">
                        <h3 class="text-base text-slate-900 relative leading-6">department</h3>
                        <p class="text-sm text-gray-600">{user.user_email}</p>
                      </div>
                    </div>
                  </div>
