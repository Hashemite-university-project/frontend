                ...
                {projects.map((project) => (
                    <article key={project.id} class="flex flex-col items-center gap-4 md:flex-row lg:gap-6">
                        ...
                        <h2 class="text-xl font-bold text-gray-800">
                            <Link to={`/projectDetails/${project.id}`} class="transition duration-100 hover:text-blue-600 active:text-blue-800">{project.project_name}</Link>
                        </h2>
                        ...
                        <div>
                            <Link to={`/projectDetails/${project.id}`} class="font-semibold text-blue-600 transition duration-100 hover:text-blue-800 active:text-blue-800">Read more</Link>
                        </div>
                        </div>
                    </article>
                ))}
