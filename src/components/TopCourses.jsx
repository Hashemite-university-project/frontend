      ...
      <div className="max-w-screen-xl mx-auto p-5 sm:p-10 md:p-16">
        ...
        {courses.map((course) => (
          ...
          >
            ...
            <Link to={`/HomeCourseDetails/${course.course_id}`} class="col-span-2 text-left text-gray-600 hover:text-gray-700">
            ...
            <div class="col-span-3 flex flex-col space-y-3 pr-8 text-left">
                <Link to={`/HomeCourseDetails/${course.course_id}`} class="mt-3 overflow-hidden text-2xl font-semibold">
                ...
                <Link to={`/HomeCourseDetails/${course.course_id}`} class="text-sm font-semibold text-gray-500 hover:text-gray-700">{course.instructor.instructor.user_name}</Link>
                ...
                <Link to={`/HomeCourseDetails/${course.course_id}`} class="my-5 rounded-md px-5 py-2 text-center transition hover:scale-105 bg-blue-600 text-white sm:ml-auto">Show Details</Link>
                </div>
            </div>
            </div>
            </motion.div>
