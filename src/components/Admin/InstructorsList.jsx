            ...
            <tbody>
              {instructors.map((instructor) => (
                <tr key={instructor.instructor_id} className="text-center">
                  ...
                  <td className="py-2 px-4 border-b">
                    {instructor.instructor.user_email}
                  </td>
                  <td className="py-2 px-4 border-b">
                    {instructor.instructor.phone_number || 'N/A'}
                  </td>
                  <td className="py-2 px-4 border-b">
        ...
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
          <div className="bg-white rounded-lg shadow-lg w-11/12 md:w-1/2 lg:w-1/3 p-6">
            ...
            <div className="space-y-2">
              ...
              <p>
                <strong>Name:</strong> {currentInstructor.instructor.user_name}
              </p>
              <p>
                <strong>Email:</strong> {currentInstructor.instructor.user_email}
              </p>
              <p>
                <strong>Phone Number:</strong>{' '}
                {currentInstructor.instructor.phone_number || 'N/A'}
              </p>
              <p>
